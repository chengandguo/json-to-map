import { isFunction, isObject, isArray, isMap } from "./utils/is";
...
*/
export default function mapStringify(
  value: any,
  ...
  const walk = (
    key: string,
    holder: Map<string, any> | { [index: string]: any }
  ) => {
    ...
    let i, // The loop counter.
      ...
      length,
      partial,
      value = isMap(holder) ? holder.get(key) : holder[key];
